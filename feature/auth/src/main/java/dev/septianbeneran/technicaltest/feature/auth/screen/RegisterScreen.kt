...
import dev.septianbeneran.technicaltest.feature.auth.screen.properties.RegisterAction
import dev.septianbeneran.technicaltest.feature.auth.screen.properties.RegisterAction.OnConfirmPasswordChange
import dev.septianbeneran.technicaltest.feature.auth.screen.properties.RegisterAction.OnEmailChange
import dev.septianbeneran.technicaltest.feature.auth.screen.properties.RegisterAction.OnLoginClick
import dev.septianbeneran.technicaltest.feature.auth.screen.properties.RegisterAction.OnNameChange
import dev.septianbeneran.technicaltest.feature.auth.screen.properties.RegisterAction.OnPasswordChange
import dev.septianbeneran.technicaltest.feature.auth.screen.properties.RegisterAction.OnRegisterClick
import dev.septianbeneran.technicaltest.feature.auth.screen.properties.RegisterEvent.NavigateToHome
import dev.septianbeneran.technicaltest.feature.auth.screen.properties.RegisterEvent.NavigateToLogin
import dev.septianbeneran.technicaltest.feature.auth.screen.properties.RegisterEvent.ShowToast
import dev.septianbeneran.technicaltest.feature.auth.screen.properties.RegisterUiState
import dev.septianbeneran.technicaltest.feature.auth.viewmodel.RegisterViewModel
